...
* interface without revealing implementation of HealthProfile's member function,
* which are defined in HealthProfile.cpp
*
...
int main()
{
	...
	cout << "user age in years:";// alerts patient for user age in years
	cin >> ageInyears;
